...
def main_menu(screen):
    ...
    while True:
        ...
        screen.blit(play_text, (constant.WIDTH//2 - play_text.get_width()//2, 300))
        screen.blit(rules_text, (constant.WIDTH//2 - rules_text.get_width()//2, 400))
        screen.blit(quit_text, (constant.WIDTH//2 - quit_text.get_width()//2, 500))
...
def game_mode_menu(screen):
    ...
    while True:
        ...
        pvp_text = FONT.render("1v1", True, constant.WHITE)
        ai_text = FONT.render("Play vs AI", True, constant.WHITE)

        screen.blit(title, (constant.WIDTH//2 - title.get_width()//2, 100))
        screen.blit(pvp_text, (constant.WIDTH//2 - pvp_text.get_width()//2, 300))
